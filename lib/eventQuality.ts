...
export function isLikelyNonEventText(text: string) {
  ...
  const hardNonEventTerms =
    /(ai-generated picture|allegedly behind numerous terror attacks|austerity|back-to-back tests|bmw museum|bcci|budget whingers|calm before storm|car makers|child well-being ranking|core national interests|court sentences|cricket|declined .* offer .* resolve|establish defence offices|fifa|fielding|gambling ads|global crisis|hip-hop|humpback|journalist|links .* consulate shooting|museum|planning big strikes|prepar(?:e|ing) for new strikes|pressures university students|prime minister advocating|private jets could signal|rap sensation|returns home from .* deployment|scam of the week|secretly operated .* bases|sedans strike back|sentenced .* jail|shoe care brand|sports|still .*love their army|suv-crazy|ticket prices|treasures of the|vaccine pioneer|videos show evolving tactics|weighs renewed .* strikes|whale|wildlife|film crew|cannes|container ships|shipyards|companies receive offer|human rights activist|dies by suicide|leaving a note|needs no advertising|no one else has analogues|defense companies|put pressure on eu|pipeline bypassing|by 2027|simplified issuance of passports|boost protection|strategic partnership|implicated in .*tapes|non-military targets|intelligence believes|could lead to|aimed at reshaping|security council meets|liberates two settlements|continue fighting for|withdraws forces|suicide drones can now skip|wants war to go on|threatened strike|pay price for|anti-war actress|letter of repentance|rejects .*mediation|peace talks|military infrastructure|missile-rocket force|assets .*rubles|изъяли активы|пригрозил ударом|отвергли план|what you need to know)/;
  const acuteTerms =
